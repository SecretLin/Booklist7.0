...
//            layout_lib.setVisibility(View.VISIBLE);
    ...
    public void query() {
        ...
        query.findObjects(BookListDetailActivity.this, new FindListener<Book>() {
            @Override
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnLike:
                if (currentUser == null) {
                    new AlertDialog.Builder(BookListDetailActivity.this).setMessage("登录后才可点赞该书哦")
                            .setPositiveButton("去登录", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    startActivity(new Intent(BookListDetailActivity.this, LoginActivity.class));
                                }
                            })
                ...
                querySum.findObjects(BookListDetailActivity.this, new FindListener<Likes>() {
                    ...
                    public void onSuccess(List<Likes> list) {
                        if (list.isEmpty()) {
                            ...
                            count++;
                            book.setCount(count);
                            book.update(BookListDetailActivity.this, new UpdateListener() {
                                @Override
...
//                dialog.getWindow().setAttributes(params);
                ...
                rvBooklist.addOnItemTouchListener(new RecyclerItemClickListener(this, rvBooklist, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        MyUser currentUser = BmobUser.getCurrentUser(BookListDetailActivity.this, MyUser.class);
                        ...
                        relationbooklist.save(BookListDetailActivity.this, new SaveListener() {
                            @Override
                            public void onSuccess() {
                                toast("添加成功");
                                dialog.dismiss();
...
//                        bb.save(BookListDetailActivity.this, new SaveListener() {
//                            @Override
//                            public void onSuccess() {
//                                toast("添加成功");
//                                dialog.dismiss();
...
//
                ...
                layout_addBooklist.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        android.support.v7.app.AlertDialog.Builder builder1 = new android.support.v7.app.AlertDialog.Builder(BookListDetailActivity.this);
                        View dialog_newbooklist = LayoutInflater.from(BookListDetailActivity.this).inflate(R.layout.dialog_newbooklist, null);
...
//                                }
                                ...
                                booklist.setMyUser(currentUser);
                                booklist.save(BookListDetailActivity.this, new SaveListener() {
                                    @Override
                                    public void onSuccess() {
                                        toast("创建成功");
                                    }
            ...
            case R.id.btnShare:
                if (currentUser == null) {
                    new AlertDialog.Builder(BookListDetailActivity.this).setMessage("登录后才可分享该书哦")
                            .setPositiveButton("去登录", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    startActivity(new Intent(BookListDetailActivity.this, LoginActivity.class));
