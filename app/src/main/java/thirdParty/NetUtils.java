...
public class NetUtils {
	 ...
	 * @return
	 */
	public static String getUsername(String urlString) {
		...
		try {
			...
			if(200 == urlConnection.getResponseCode()){
				...
				String result  = "["+baos.toString("utf-8")+"]";
					...
					username = resultObj.getString("nickname");
	...
	public static String getHeadUrl(String urlString) {
		...
		try {
			...
			if(200 == urlConnection.getResponseCode()){
				...
				JSONArray resultArray = new JSONArray(result);
				JSONObject resultObj = resultArray.optJSONObject(0);
				headUrl = resultObj.getString("figureurl_2");
